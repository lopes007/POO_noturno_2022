 ...
 * @author Fatec
 */
@WebServlet(name = "JurosSimplesServlet", urlPatterns = {"/juros-simples.json"})
public class JurosSimplesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            if(request.getParameter("capital")!=null && request.getParameter("taxa")!=null && request.getParameter("periodo")!=null ){
